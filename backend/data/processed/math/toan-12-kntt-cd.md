...
CÙNG THẾ ANH – ĐẶNG HÙNG THẮNG (đồng Chủ biên)
...
NATIONAL DISABILISATION FEDERATION# HỘI ĐỒNG QUỐC GIA THẨM ĐỊNH SÁCH GIÁO KHOA
...
Chuyên đề “Ứng dụng toán học để giải quyết một số bài toán tối ưu” trình bày hai phương pháp cơ bản để giải một số bài toán tối ưu thường gặp trong thực tiễn và trong kinh tế, đó là phương pháp hình học giải bài toán quy hoạch tuyến tính và phương pháp đạo hâm.

Các kiến thức về tài chính là học vấn thiết yếu của mọi công dân thế kỉ XXI. Chuyên đề “Ứng dụng toán học trong một số vấn đề liên quan đến tài chính” sẽ giúp các em làm quen với việc quản lí tài chính cá nhân, đó là biết cách tính lãi suất của các khoản vay, gửi tiết kiệm hay đầu tư, biết thiết lập kế hoạch tài chính cá nhân cho các nhu cầu dài hạn.
...
## CHUYÊN ĐỀ 1
### BIỂN NGẪU NHIÊN RỜI RẠC. CÁC SỐ ĐẶC TRƯNG CỦA BIỂN NGẪU NHIÊN RỜI RẠC
...
## CHUYÊN ĐỀ 2
### ỨNG DỤNG TOÁN HỌC ĐỀ GIẢI QUYẾT MỘT SỐ BÀI TOÁN TỐI ƯU
...
## CHUYÊN ĐỀ 3
### ỨNG DỤNG TOÁN HỌC TRONG MỘT SỐ VẤN ĐỀ LIÊN QUAN ĐẾN TÀI CHÍNH
...
| --- | --- |
|  Bảng giải thích thuật ngữ | 71  |5
...
## 1. BIỂN NGẪU NHIÊN RỜI RẠC VÀ BẢNG PHÂN BỖ XÁC SUẤT CỦA NÓ

### HỌ1. Hình thành khái niệm biến ngẫu nhiên rời rạc
...
**HỌ2.** Củng cố khái niệm bảng phân bố xác suất của biến ngẫu nhiên rời rạc
...
c) Xảy ra ít nhất 2 vụ vi phạm Luật Giao thông.8
...
Số kết quả thuận lợi cho biến cố $\{X = 3\}$ là $C_4^3 = 4$. Do đó $P(X = 3) = \frac{4}{120} = \frac{1}{30}$.Bảng phân bố xác suất của X là:
...
**Trở lại HĐ4.** Gọi X và Y tương ứng là doanh thu theo phương án 1 và phương án 2. Tính độ lệch chuẩn của X và Y.12
...
b) Tính $V(X)$ theo công thức (2).BÀI TẬP
...
Từ (1) và (2) ta suy ra $P(X = k) = \left(\frac{5}{6}\right)^{k-1} \cdot \frac{1}{6}$.Bài 2
...
## 1. PHÉP THỬ LẬP VÀ CÔNG THỨC BERNOULLI
...
&gt; **HỌI.** Hình thành khái niệm phép thử lặp và công thức Bernoulli
...
Công thức trên được gọi là **công thức Bernoulli**.16
...
# 2. BIỂN NGẪU NHIÊN CÓ PHÂN BỔ NHỊ THỨC VÀ ÁP DỤNG
...
**H02. Hình thành khái niệm biến ngẫu nhiên có phân bố nhị thức**
...
Viết bảng phân bố xác suất của biến ngẫu nhiên có phân bố Bernoulli.Nhận xét. Cho $T$ là một phép thử và $E$ là một biến cố liên quan tới phép thử $T$. Ta thực hiện phép thử $T$ lặp lại $n$ lần một cách độc lập. Ở mỗi lần thực hiện phép thử $T$, biến cố $E$ có xác suất xuất hiện bằng $p$, $P(E) = p$. Gọi $X$ là số lần xuất hiện biến cố $E$ trong $n$ lần thực hiện lặp lại phép thử $T$. Khi đó $X \sim B(n, p)$.
...
18Chú ý. Người ta chứng minh được rằng kì vọng, phương sai và độ lệch chuẩn của biến ngẫu nhiên $X - B(n,p)$ được cho bởi các công thức sau:
...
Tính tỉ lệ các thùng cam được xếp loại I, II, III.BÀI TẬP CUỐI CHUYÊN ĐỀ 1
...
# 1. GIỚI THIỆU BÀI TOÁN QUY HOẠCH TUYỀN TÍNH HAI BIỂN

**HỌI.** Trong bài toán mở đầu, gọi $x$ và $y$ lần lượt là số kilôgam sản phẩm loại I và loại II cần sản xuất.
...
Các bài toán như vậy gọi là bài toán quy hoạch tuyến tính hai biển. Biểu thức $F(x; y)$ ở trên gọi là hàm mục tiêu.
...
a) Đặt ấn và viết bài toán quy hoạch tuyến tính diễn tả yêu cầu của bài toán trên.

b) Biểu diễn tập các phương án chấp nhận được và tìm các phương án cực biên.

# 2. BÀI TOÁN QUY HOẠCH TUYỀN TÍNH VỚI MIỀN CHẤP NHẬN ĐƯỢC LÀ MIỀN ĐA GIÁC

&gt; **HD2.** Ta giải bài toán trong Tình huống mở đầu.

Từ HD1 ta có bài toán quy hoạch tuyến tính sau:
...
Hình 2.3b) Với mỗi số thực $m$ xét đường thẳng $d_m : 40x + 30y = m$.
...
Các điểm cực biên là: $O(0; 0)$, $A(1; 0)$, $B(2; 1)$, $C(2; 2)$, $D\left(\frac{4}{3}; \frac{10}{3}\right)$, $E(0; 4)$.Bước 5. Bài toán yêu cầu tìm giá trị lớn nhất của $F(x; y)$ trên miền lục giác OABCDE.
...
## 1. VẬN DỤNG ĐẠO HÀM ĐỂ GIẢI QUYẾT MỘT SỐ BÀI TOÁN TỐI ƯU TRONG THỰC TIỀN
...
|  2 000 | 95 400 | 86 | 47,7  |b) Ta cần tìm $x$ để $c(x)$ nhỏ nhất. Ta có:
...
Hình thức gửi tiền nào có lợi hơn cho bác An?47
...
Hình thức trao đổi trực tiếp hàng hóa khi chưa xuất hiện tiền tệ (tranh minh hoạ)48
...
## HÒI. Xây dựng công thức lãi đơn
...
&gt; HO2. Xây dựng công thức lãi kép
...
d) Nếu tỉ lệ lạm phát trung bình hằng năm là 3%, thì sẽ mất bao lâu để chỉ số giá tiêu dùng tăng gấp đôi?Bài 6
...
## 2. VAY NỢ CỦA CÁC TỔ CHỨC TÌN DỤNG
...
Vì về phải có thể không nguyên, nên thực tế ta sẽ phải chọn $N$ là số tự nhiên nhỏ nhất lớn hơn hay bằng về phải.62
...
b) Lãi suất đơn hằng năm của khoản gửi này là bao nhiêu?c) Xác định giá trị hiện tại của một khoản tiền
...
&gt; **HỌI.** Xây dựng công thức tính giá trị hiện tại của một khoản tiền
...
Như vậy, tài khoản của bạn Nam sẽ không đủ tiền để thanh toán cho chuyến đi trải nghiệm thực tế.d) Nếu bạn Nam gửi 600 nghìn đồng mỗi tháng, kể từ ngày 1/2, thì hệ thức truy hồi biểu thị số tài khoản của bạn Nam sau $n$ tháng là
...
[APN] [APN] [CAL] [APN] [APN] [CAL] [APN] [CAL] [APN] [CAL] [APN] [C=1] [APN] [C=1] [APN] [C=1] [APN] [C=1]
...
Ta tiếp tục bấm phím [CAL] và lần lượt nhập các giá trị $x = 0$, $A = 1$, sau đó bấm phím [C=].
...
|  7 | 5 | 3.550376566  |
|  8 | 6 | 4.068128449  |
|  9 | 7 | 4.588469091  |BÀI TẬP CUỐI CHUYÊN ĐỀ 3
...
|  Phân bố nhị thức | Phân bố xác suất rời rạc với hai tham số n và p, kí hiệu của số lượng lượt thử thành công trong n lượt thử độc lập với kết quả CỔ hoặc KHÔNG thành công  |Nhà xuất bản Giáo dục Việt Nam xin trân trọng cảm ơn các tác giả có tác phẩm, tư liệu được sử dụng, trích dẫn trong cuốn sách này.
...
27. Mĩ thuật 12 – Thiết kế mi thuật đa phương tiện
28. Mĩ thuật 12 – Thiết kế đồ hoạ
29. Mĩ thuật 12 – Thiết kế thời trang
30. Mĩ thuật 12 – Thiết kế mi thuật sân khấu, điện ảnh
31. Mĩ thuật 12 – Lí luận và lịch sử mi thuật
...
37. Chuyên đề học tập Mi thuật 12
38. Âm nhạc 12
