...
PHAN THANH HỒNG – TRẦN ĐỈNH KẾ – PHẠM ANH MINH – NGUYỄN THỊ KIM SƠN
...
NGUYỄN DOĂN PHÚ – NGUYỄN CHIẾN THẮNG – NGUYỄN THỊ VĨNH THUYỀN
ĐỊNH CAO THƯỢNG – PHẠM ĐÌNH TÙNG – VŨ THỊ NHƯ TRANG (Uỷ viên)HÀ HUY KHOÁI (Tổng Chủ biên)
...
|  Tính nguyên hàm và tích phân với phần mềm GeoGebra. | 81  |
| --- | --- |
...
|  Bảng giải thích thuật ngữ | 95  |4
...
**HỌI.** Nhận biết khái niệm nguyên hàm

Cho hai hàm số $f(x) = x^2 + 1$ và $F(x) = \frac{1}{3}x^3 + x$, với $x \in \mathbb{R}$.

a) Tính đạo hàm của hàm số $F(x)$.
b) $F'(x)$ và $f(x)$ có bằng nhau không?Cho hàm số $f(x)$ xác định trên một khoảng $K$ (hoặc một đoạn, hoặc một nửa khoảng). Hàm số $F(x)$ được gọi là một nguyên hàm của hàm số $f(x)$ trên $K$ nếu $F'(x) = f(x)$ với mọi $x$ thuộc $K$.
...
\left(\sqrt{x}\right)' = \frac{1}{2\sqrt{x}} \quad \text{hay} \quad \left(x^{\frac{1}{2}}\right)' = \frac{1}{2} x^{\frac{1}{2}-1} \quad (x &gt; 0).
\end{array}
$$
...
&gt; Bằng cách viết lại các hàm số sau dưới dạng hàm số luỹ thừa $y = x^{\alpha}$ ($x &gt; 0$), hãy tính đạo hàm của các hàm số sau với $x &gt; 0$: $y = \frac{1}{x^{\alpha}}$; $y = x^{\sqrt{2}}$; $y = \frac{1}{\sqrt[3]{x}}$.
...
b) $\int \left(\frac{1}{\cos^2 x} - \frac{1}{\sin^2 x}\right) dx.$10
...
\bullet \int a^x dx = \frac{a^x}{\ln a} + C (0 &lt; a \neq 1).
\end{array}
$$
...
|  ∫(1/sin^2/x) dx = -cot x + C | ∫(1/cos^2/x) dx = \tan x + C  |Dựa vào bảng nguyên hàm của các hàm số thường gặp và tính chất cơ bản của nguyên hàm, ta có thể tìm được nguyên hàm của nhiều hàm số khác.
...
# HO2. Diện tích của hình thang cong
...
Từ Định lỉ 1 và định nghĩa tích phân, ta có
...
Hình 4.10b) Ta có $y = \sqrt{1 - x^2}$ là phương trình nửa phía trên trục hoành của đường tròn tâm tại gốc toạ độ O và bán kính 1. Do đó, tích phân cần tính là diện tích nửa phía trên trục hoành của hình tròn tương ứng (H.4.11).
...
**H04.** Nhận biết tính chất của tích phân
...
4) $\int_{a}^{b} f(x) \, dx = \int_{a}^{c} f(x) \, dx + \int_{c}^{b} f(x) \, dx$ ($a &lt; c &lt; b$).17
...
ỨNG DỤNG HÌNH HỌC CỦA TÍCH PHẦN
...
**HỌI.** Nhận biết công thức tính diện tích
...
Hình 4.12Ví dụ 1. Tính diện tích hình phẳng giới hạn bởi đồ thị của hàm số $y = x^3$, trục hoành và hai đường thẳng $x = 0$, $x = 2$ (H.4.13).
...
**HO2. Nhận biết công thức tính diện tích**
...
Hình 4.16a) Giả sử $S_1$ là diện tích hình phẳng giới hạn bởi parabol $y = -x^2 + 4x$, trục hoành và hai đường thẳng $x = 1$, $x = 3$; $S_2$ là diện tích hình phẳng giới hạn bởi đường thẳng $y = x$, trục hoành và hai đường thẳng $x = 1$, $x = 3$. Tính $S_1$, $S_2$ và từ đó suy ra $S$.
...
Luyện tập 2. Tính diện tích hình phẳng giới hạn bởi đồ thị của các hàm số $y = \sqrt{x}$, $y = x - 2$ và hai đường thẳng $x = 1$, $x = 4$.Vận dụng 1. Ta biết rằng hàm cầu liên quan đến giá $p$ của một sản phẩm với nhu cầu của người tiêu dùng, hàm cung liên quan đến giá $p$ của sản phẩm với mức độ sẵn sàng cung cấp sản phẩm của nhà sản xuất. Điểm cắt nhau $(x_0; p_0)$ của đồ thị hàm cầu $p = D(x)$ và đồ thị hàm cung $p = S(x)$ được gọi là điểm cân bằng.
...
**HỌI.** Nhận biết công thức tính thể tích vật thể
...
Hình 4.21Ví dụ 5. Tính thể tích của khối lăng trụ có diện tích đáy bằng $S$ và chiều cao bằng $h$.
...
4.18. Khối chỏm cầu có bán kính $R$ và chiều cao $h$ ($0 &lt; h \leq R$) sinh ra khi quay hình phẳng giới hạn bởi cung tròn có phương trình $y = \sqrt{R^2 - x^2}$, trục hoành và hai đường thẳng $x = R - h$, $x = R$ xung quanh trục $Ox$ (H.4.30). Tính thể tích của khối chỏm cầu này.
...
4.19. Cho tam giác vuông $OAB$ có cạnh $OA = a$ nằm trên trục $Ox$ và $\widehat{AOB} = \alpha \left(0 &lt; \alpha \leq \frac{\pi}{4}\right)$.
...
Hình 4.31BÀI TẬP CUỐI CHƯƠNG IV
...
D. $\frac{76}{15}$4.26. Cho hình phẳng (S) giới hạn bởi đồ thị hàm số $ y = \sqrt{1 - x^2} $, trục hoành và hai đường thẳng $ x = -1 $, $ x = 1 $. Thế tích của khối tròn xoay khi quay (S) quanh $ Ox $ là
...
&gt; **HỌL** Hình thành khái niệm vector pháp tuyến
...
$$
[\vec{u}, \vec{v}] = \begin{pmatrix} |b &amp; c \\ |b' &amp; c'| \end{pmatrix} \begin{vmatrix} |c &amp; a \\ |c' &amp; a'| \end{vmatrix} \begin{vmatrix} |a &amp; b \\ |a' &amp; b'| \end{pmatrix}.
$$Ví dụ 2. Trong không gian Oxyz, cho $\vec{u} = (1; -2; 0)$ và $\vec{v} = (3; 1; -4)$. Tính $[\vec{u}, \vec{v}]$.

Giải

Ta có $[\vec{u},\vec{v}] = \begin{pmatrix} -2 &amp; 0 &amp; 0 &amp; 1 \\ 1 &amp; -4 &amp; 1 &amp; -4 \end{pmatrix} = \begin{pmatrix} 0 &amp; 1 &amp; 1 \\ -4 &amp; 3 &amp; 3 \end{pmatrix} = (8; 4; 7)$.

Luyện tập 2. Trong không gian Oxyz, cho $\vec{u} = (2; 3; 1)$ và $\vec{v} = (4; 6; 2)$. Tính $[\vec{u}, \vec{v}]$.

H03. Hình thành khái niệm cặp vectơ chỉ phương của mặt phẳng
...
Mặt phẳng (A'B'C') nhận $\overline{AB} = (3; 1; 2), \overline{AC} = (1; 1; -1)$ làm cặp vectơ chỉ phương nên có vectơ pháp tuyến là
...
# 4. ĐIỀU KIỆN ĐỀ HAI MẶT PHẲNG VUÔNG GÓC VỚI NHAU

HĐB. Tìm điều kiện để hai mặt phẳng vuông góc
...
![img-52.jpeg](img-52.jpeg)Trong không gian Oxyz, cho hai mặt phẳng:
...
Hình 5.105. ĐIỀU KIỆN ĐỂ HAI MẶT PHẲNG SONG SONG VỚI NHAU

H09. Tìm điều kiện để hai mặt phẳng song song hoặc trùng nhau
...
## H010. Thiết lập công thức tính khoảng cách từ một điểm đến một mật phẳng
...
Hình 5.17 | Mặt hyperboloid một tầng (H.5.18) có phương trình:
$\frac{x^2}{a^2} + \frac{y^2}{b^2} - \frac{z^2}{c^2} = 1$.

![img-66.jpeg](img-66.jpeg)

Hình 5.18 | Mặt hyperboloid hai tầng (H.5.19) có phương trình:
$\frac{x^2}{a^2} + \frac{y^2}{b^2} - \frac{z^2}{c^2} = -1$.
...
Hình 5.20 | Mặt paraboloid elliptic (H.5.21) có phương trình:
$z = \frac{x^2}{a^2} + \frac{y^2}{b^2}$

![img-69.jpeg](img-69.jpeg)

Hình 5.21 | Mặt paraboloid hyperbolic hay còn gọi là mặt yên ngựa (H.5.22) có phương trình:
$z = \frac{x^2}{a^2} - \frac{y^2}{b^2}$
...
(a, b, c &gt; 0 và không bằng nhau.)Bài 15
...
H04. Lập phương trình đường thẳng đi qua hai điểm
...
H05. Tìm điều kiện để hai đường thẳng vuông góc với nhau
...
Hỏi hai con đường trên có vuông góc với nhau hay không?46
...
# Vận dụng 3. (H.5.30) Trong không gian Oxyz, có hai vật thể lần lượt xuất phát từ A(1; 2; 0) và B(3; 5; 0) với vận tốc không đổi tương ứng là $\overline{v_1} = (2; 1; 3), \overline{v_2} = (1; 2; 1)$. Hỏi trong quá trình chuyển động, hai vật thể trên có va chạm vào nhau hay không?
...
CÔNG THỨC TỈNH GÓC TRONG KHÔNG GIAN
...
## 1. CÔNG THỨC TỈNH GÓC GIỮA HAI ĐƯỜNG THẲNG

**HỌI.** Tìm mối quan hệ của góc giữa hai đường thẳng và góc giữa hai vector chi phương
...
# 2. CÔNG THỨC TỈNH GÓC GIỮA ĐƯỜNG THẲNG VÀ MẶT PHẲNG
...
# 3. CÔNG THỨC TỈNH GÓC GIỮA HAI MẶT PHẲNG

**HÔI.** Tìm mối quan hệ của góc giữa hai mặt phẳng và góc giữa hai vectơ pháp tuyến
...
b) Tính cõsín của góc giữa hai mặt phẳng $(P)$ và $(Q)$.
...
![img-87.jpeg](img-87.jpeg)Gọi φ là góc giữa hai mặt phẳng (ABD) và (ACD). Khi đó:
...
![img-90.jpeg](img-90.jpeg)Bài 17
...
Mặt cầu tâm / bán kính $R$ ($R &gt; 0$) là tập các điểm trong không gian cách / một khoảng bằng $R$.

Một điểm $M$ được gọi là nằm trong mặt cầu tâm / bán kính $R$ nếu $IM &lt; R$ và được gọi là nằm ngoài mặt cầu đó nếu $IM &gt; R$. Mỗi đường thẳng đi qua tâm mặt cầu đều cắt mặt cầu tại hai điểm phân biệt, đoạn thẳng nối hai điểm đó được gọi là một đường kính của mặt cầu. Mỗi đường kính của mặt cầu đều có trung điểm là tâm mặt cầu và có độ dài bằng hai lần bán kính mặt cầu.

&gt; **HỌI.** Tìm phương trình mặt cầu biết tâm và bán kính
...
Xác định tâm, tính bán kính của (S).# 2. MỘT SỐ ỨNG DỤNG CỦA PHƯƠNG TRÌNH MẶT CẤU TRONG THỰC TIỀN
...
Nếu biết vĩ độ và kinh độ của một vị trí trên mặt đất thì toạ độ của nó trong không gian cũng dễ dàng được xác định và ngược lại. Chẳng hạn, vị trí P có vĩ độ, kinh độ tương ứng là $$\alpha^\circ N$$, $$\beta^\circ E$$ (0 &lt; α &lt; 90, 0 &lt; β &lt; 180) có toạ độ P (cos α° cos β°; cos α° sin β°; sin α°) (H.5.43), vị trí Q có vĩ độ, kinh độ tương ứng là $$\alpha^\circ N$$, $$\beta^\circ W$$ (0 &lt; α &lt; 90, 0 &lt; β &lt; 180) thì có toạ độ Q (cos α° cos β°; - cos α° sin β°; sin α°) (H.5.44).
...
$$
\overline{OP} = \left(\cos 10^{\circ} \cos 15^{\circ}; \cos 10^{\circ} \sin 15^{\circ}; \sin 10^{\circ}\right), \quad \overline{OQ} = \left(\cos 80^{\circ} \cos 70^{\circ}; \cos 80^{\circ} \sin 70^{\circ}; \sin 80^{\circ}\right).
$$
...
$$
\begin{array}{l}
\overline{OP} \cdot \overline{OQ} = \cos 10^{\circ} \cos 15^{\circ} \cos 80^{\circ} \cos 70^{\circ} + \cos 10^{\circ} \sin 15^{\circ} \cos 80^{\circ} \sin 70^{\circ} + \sin 10^{\circ} \sin 80^{\circ} \\
\approx 0,2691.
\end{array}
$$

Vì $P, Q$ thuộc mặt đất nền $|\overline{OP}| = |\overline{OQ}| = 1$.

Do đó $\cos \widehat{P O Q} = \frac{\overline{OP} \cdot \overline{OQ}}{|\overline{OP}| \cdot |\overline{OQ}|} \approx 0,2691$. Suy ra $\widehat{P O Q} \approx 74,3893^{\circ}$.
...
**Trải nghiệm.** Trên Google Maps, thực hiện phép đo khoảng cách từ vị trí $0^{\circ}N$, $0^{\circ}E$ đến vị trí $45^{\circ}N$, $30^{\circ}E$ và so sánh với kết quả tính được ở Luyện tập 5.BÀI TẬP
...
- Vị trí $P$ của GPS có tung độ dương nên thuộc bán cầu Đông và có cao độ dương nên thuộc bán cầu Bắc. Gọi vĩ độ, kinh độ của $P$ tương ứng là $\alpha^\circ N$, $\beta^\circ E$ ($0 &lt; \alpha &lt; 90$, $0 &lt; \beta &lt; 180$). Khi đó $P(\cos \alpha^\circ \cos \beta^\circ; \cos \alpha^\circ \sin \beta^\circ; \sin \alpha^\circ)$.
...
615.38. Trong không gian Oxyz, cho mặt cầu $(S): (x + 1)^2 + y^2 + (z - 3)^2 = 4$. Tọa độ tâm / và bán kính $R$ của $(S)$ lần lượt là
...
Ở cửa bí mật (Let's Make a Deal) là một trò chơi trên truyền hình nổi tiếng ở Mỹ, đã được mua bản quyền và phát sóng ở nhiều nước trên thế giới. Nội dung trò chơi như sau:
...
Các kiến thức trong bài học này sẽ giúp ta cho người chơi lời khuyên.65
...
## HỎI. Hình thành khái niệm xác suất có điều kiện
...
|  Kết quả
Thắt dây an toàn | Tử vong | Sống sót  |
| --- | --- | --- |
|  Không | 1 601 | 162 527  |
|  Có | 510 | 412 368  |67
...
**H02. Hình thành công thức nhân xác suất**
...
![img-107.jpeg](img-107.jpeg)Nếu $A$ xảy ra tức là bạn Sơn lấy được bút bi đen thì trong hộp có 11 bút bi với 7 bút bi xanh.
...
Trên nhánh $\mathcal{DD}$, $\mathcal{EX}$ tương ứng ghi xác suất lấy được bút đen, bút xanh với điều kiện đã lấy được bút đen.
...
69b) Sử dụng công thức tính xác suất có điều kiện và công thức nhân xác suất, chứng minh rằng:
...
Nguồn ảnh: Daniel Shea, nytimes.com.Bài 19 CÔNG THỨC XÁC SUẤT TOÀN PHẦN VÀ CÔNG THỨC BAYES
...
## HO1. Hình thành công thức xác suất toàn phần
...
$$
Công thức trên được gọi là công thức xác suất toàn phần.73
```markdown
...
Hình 6.2. Sơ đồ hình cây mô tả xác suất của biến cố74
...
Chong thức Bayes đóng vai trò quan trọng trong Lí thuyết Xác suất.
Thomas Bayes
(1701 – 1761)
...
6.18. Để thử nghiệm tác dụng điều trị bệnh mất ngủ của hai loại thuốc X và thuốc Y, người ta tiến thành thử nghiệm trên 4 000 người bệnh tình nguyện. Kết quả được cho trong bảng thống kê $2 \times 2$ sau:80
...
6.21. Một loại vaccine được tiêm ở địa phương X. Người có bệnh nền thì với xác suất 0,35 có phản ứng phụ sau tiêm; người không có bệnh nền thì chỉ có phản ứng phụ sau tiêm với xác suất 0,16. Chọn ngẫu nhiên một người được tiêm vaccine và người này có phản ứng phụ. Tính xác suất để người này có bệnh nền, biết rằng tỉ lệ người có bệnh nền ở địa phương X là 18%.HOẠT ĐỘNG
...
Để tính gần đúng tích phân, ta dùng lệnh NIntegral (<hàm sổ,="" giá="" cuối="" trị="" thì="">), kết quả sẽ được hiển thị ngay bên dưới.

|  1 | NIntegral(1+x/√x, 1, 30)
→ 117.83  |
| --- | --- |
|  1 | NIntegral((sin(x) + cos(x))², 0, π/2)
→ 2.57  |
|  1 | NIntegral(√1 + sin2x, 0, π)
→ 4.95  |
| --- | --- |
|  1 | NIntegral(x² e^x, -1, 1)
→ 0.88  |
...
| --- | --- | --- |
|  Tính nguyên hàm | IntegralSymbolic ( | TíchPhân (  |
|  Tính tích phân | NIntegral ( | TíchPhânXácĐịnh (  |
...
2. TÍNH GẮN ĐÚNG TÍCH PHÂN BẰNG PHƯƠNG PHÁP HÌNH THANG
...
không phải là những hàm số sơ cấp, thì không thể dùng định nghĩa trên được. Tình huống tương tự xuất hiện khi $f(x)$ cho bởi một đồ thị mà ta không biết phương trình của nó. Khi đó, ta cần tính xấp xỉ $\int_a^b f(x) \, dx$ bằng các phương pháp số.</hàm></hàm>Phương pháp đơn giản nhất là phương pháp hình thang, có nội dung như sau:
...
Thể tích cần tính là $V = \int_{0}^{4\pi i} S(x) dx$, trong đó $S(x)$ là diện tích mặt cắt ngang tại vị trí cách đỉnh thân cây một khoảng $x$ (cm). Sử dụng phương pháp hình thang để tính gần đúng tích phân này.VẸ ĐỒ HOẠ 3D VỚI PHẦN MỀM GEOGEBRA
...
85Tronghogtđongtraignhiêm nay, em hay theo hướng dẫn sau, để vẽ tam giác Penrose bangcach dung cac hinh hop chur nhát va lura chon môt góc nhin thích hop.

Chú y. Sử dụng giao diên GeoGebra bang Tiếng Việt: Vào muc Thiet lap, chon Ngôn ngũ, chon Tiếng Việt. Các hướng dẫn được đưa ra trong bài hoc nay ưng với phiên bản GeoGebra Classic.

- Buoc 1. Mô phàn mèm GeoGebra, vào mục Hiến thi và lan luot lura chon cac muc sau: Hiến thi danh sách đối tượng, Vùng lam viêc, Hiến thi dang 3D, Khung nhap lênh.

![img-119.jpeg](img-119.jpeg)

- Buoc 2. Trong Khung nhap lênh, lan luot su dung cac doan lênh sau:

|  Đoan lênh | Ý nghĩa  |
| --- | --- |
|  DaGiac((0, 0, 0), (-1, 0, 0), 4, TrucTung) | Hình vuông có toa độ 2 dinh là (0, 0, 0), (-1, 0, 0) và nàm trong mát phẳng (Oxz).  |
|  DaGiac((0, 9, 0), (0, 10, 0), 4, TrucZ) | Hình vuông có toa độ 2 dinh là (0, 9, 0), (0, 10, 0) và nàm trong mát phẳng (Oxy).  |
|  DaGiac((-1, 0, 0), (-1, 1, 0), 4, TrucHoanh) | Hình vuông có toa độ 2 dinh là (-1, 0, 0), (-1, 1, 0) và nàm trong mát phẳng (Oyz).  |
|  HinhLăngTrú(TenDaGiac1, 9) | Hinh lăng trú có đáy là TenDagiac1 và chiều cao bang 9 nàm ở phần dương của trúc Oy.  |
|  HinhLăngTrú(TenDaGiac2, 9) | Hinh lăng trú có đáy là TenDagiac2 và chiều cao bang 9 nàm ở phần dương của trúc Oz.  |
|  HinhLăngTrú(TenDaGiac3, -9) | Hinh lăng trú có đáy là TenDagiac3 và chiều cao bang 9 nàm ở phần âm của trúc Ox.  |
|  DaGiac((0, 9, 0), (0, 10, 0), (0, 10, 9), (0, 9, 8)) | Đa giác có toa độ 4 dinh là (0, 9, 0), (0, 10, 0), (0, 10, 9), (0, 9, 8).  |- Bước 3. Di chuyển con trỏ vào khoảng trắng trong khung Hiển thị danh sách đối tượng, sau đó nháy chuột phải, lựa chọn mục Các đối tượng phụ.
...
Mat2, q1 (ở đây ta tô hai mặt này màu xanh lá cây).- Bước 6. Di chuyển con trỏ vào khoảng trắng trong khung Vùng làm việc, chọn công cụ để chèn nút tạo góc nhìn thích hợp.
...
88bô từ một vị trí ở phần giấy được tô màu đỏ sang bất kỳ vị trí nào ở phần giấy được tô màu xanh mà không cần leo qua mép của mặt Mobius.
...
(với $u$, $v$ là các tham số thay đổi, thoả mãn $0 \leq u &lt; 2\pi$ và $-1 \leq v \leq 1$), là một mặt Mobius.
...
![img-131.jpeg](img-131.jpeg)BÀI TẬP ÔN TẬP CUỐI NĂM
...
![img-133.jpeg](img-133.jpeg)Khẳng định nào dưới đây là đúng?
...
D. 4,09.14. Trong một nhóm 25 người, có 15 người thích uống trà, 17 người thích uống cà phê, 9 người thích uống cá cà phê và trà. Chọn ngẫu nhiên một người trong nhóm. Biết rằng người đó thích uống cà phê. Xác suất để người đó thích uống trà là
...
b) Nếu $AB \perp CD$ và $AC \perp BD$ thì $AD \perp BC$.24. Cho hình lập phương $ABCD.A'B'C'D'$ có cạnh bằng $a$. Gọi $G$ là trọng tâm của tam giác $BC'D'$.
...
|  Xác suất có điều kiện | Xác suất của một biến cố $A$ nào đó, biết rằng một biến cố $B$ khác xảy ra  |Nhà xuất bản Giáo dục Việt Nam xin trân trọng cảm ơn các tác giả có tác phẩm, tư liệu được sử dụng, trích dẫn trong cuốn sách này.
...
In xong và nộp lưu chiều Quý ... năm 20...
Mã số ISBN: Tập một: ...
Tập hai: ...2

HUÂN CHƯƠNG NỔ CHÍ MINH
